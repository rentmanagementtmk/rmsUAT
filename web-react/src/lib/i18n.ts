// Translation dictionary — ported unchanged from assets/js/i18n.js.
export const TRANSLATIONS: Record<'en' | 'kn', Record<string, string>> = {
  en: {
    ...
    'msg.fill_field':         'Please fill out this field.',
    'msg.saved':              'Saved!',
  ...
  kn: {
    ...
    'msg.fill_field':         'ದಯವಿಟ್ಟು ಈ ಕ್ಷೇತ್ರವನ್ನು ಭರ್ತಿ ಮಾಡಿ.',
    ...
    'validate.close':         'ಮುಚ್ಚಿ',
    'validate.passed':        'ಉತ್ತೀರ್ಣ',
...
export function getLang(): Lang {
  return (localStorage.getItem('rms-lang') as Lang) || 'en';
}
...
/** Returns the translated string for key, falling back to English, falling back to the key itself */
